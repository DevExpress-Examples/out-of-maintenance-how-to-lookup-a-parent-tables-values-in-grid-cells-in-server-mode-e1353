<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="NorthwindNestedFields._Default" %>

<%@ Register assembly="DevExpress.Web.ASPxGridView.v8.3, Version=8.3.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxGridView" tagprefix="dxwgv" %>
...
<%@ Register assembly="DevExpress.Data.v8.3.Linq, Version=8.3.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Data.Linq" tagprefix="dxdtlnq" %>
...
<body>
    ...
    <div>
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
            ContextTypeName="NorthwindNestedFields.DataClasses1DataContext" 
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataComboBoxColumn FieldName="CustomerID" 
                    Caption="Customer's CompanyName (ComboBox)" VisibleIndex="1">
<PropertiesComboBox ValueType="System.String" DataSourceID="LinqDataSource1" 
                        TextField="CompanyName" ValueField="CustomerID"></PropertiesComboBox>
